...
<template>
  <div>
    <class-header isback='false' title="老师事务"></class-header>
      ...
      <div class="affairs-index">
        <div class="parent-affairs-list user-center">
          <div class="bd  mint-cell-change">
            ...
            <mt-cell title="学生请假" class="bg-white border-radius-10 border-grey-d class-index" @click.native="leaveClick">
